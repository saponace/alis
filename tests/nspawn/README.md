...
This will create the base rootfs on first use and reuse it on later runs. If `ALIS_NSPAWN_BASE_ROOTFS` is unset, `tests/nspawn/test.sh` defaults to `/var/lib/machines/alis`.
